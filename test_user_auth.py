...
class TestUserAuth:
    def test_auth_user(self):
        ...
        assert user_id_from_auth_method == user_id_from_check_method, "User id from auth method id not equal to user id from check method"
    ...
    def test_negative_auth_check(self, condition):
        ...
        assert "user_id" in response1.json(), "There is no usrer id in second response"
